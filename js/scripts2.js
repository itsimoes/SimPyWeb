...
function init() {
      ...
      $(go.Diagram, "myDiagramDiv",  // create a Diagram for the DIV HTML element
        {
          ...
          initialContentAlignment: go.Spot.BottomCenter,
    ...
    var nodeDataArray = [
      { key: "Source", text: "Source", color: "lightblue"},
      { key: "Queue", text: "Queue", color: "orange"},
      { key: "Fork", text: "Fork", color: "yellow"},
      { key: "Exit", text: "Exit", color: "lightgreen"}
    ];
    var linkDataArray = [
